...
\begin{table}[h!]
 ...
 \end{table}
The comparison varying the number of sensors was restricted to the KF because the results made it clear that a signle sensor had poor performance, as seen in Figure \ref{fig:sensorsKF}
\begin{figure}[h!]
 	\centering
